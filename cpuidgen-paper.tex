...
\begin{itemize}
    ...
    \item Availability of ISA extensions such as 64 bit mode, SSEx, AVX, MOVBE etc.
    ...
    \item Numerous architectural variables, such as addresses widths (leaf 0x80000008), availability of dynamic frequency scaling etc.
\end{itemize}
